...
class Course(models.Model):#如果要有数据的话外键设置null=true blank=true 不然会提示
    course_org = models.ForeignKey(CourseOrg, verbose_name=u"课程机构", null=True, blank=True)
    name = models.CharField(max_length=50, verbose_name=u"课程名")
    desc = models.CharField(max_length=300, verbose_name=u"课程描述")
    detail = models.TextField(verbose_name=u"课程详情")#之前数据库有数据 无法指定外键默认值 所以要加上 null=True, blank=True 可以为空
...
#一个model两次管理器 一定要写proxy 不然就会在生成一张表
